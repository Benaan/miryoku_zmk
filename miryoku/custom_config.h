...
U_NP,              U_NP,              U_LT(U_SYM, ESC),  U_LT(U_NAV, SPC),  U_MT(LSHFT, TAB)  ,U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              &kp ESC,           &kp SPC,           U_MT(LSHFT, TAB),  &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_LAYER_NAV \
U_NA,              U_NA,              U_NA,              U_NA,              U_BOOT,            U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
